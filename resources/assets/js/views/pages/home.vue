...
<script>
    ...
    export default {
        ...
        methods: {
            getTodos(){
                axios.get('/api/v1/todo?show_todo_status='+this.show_todo_status).then(response =>  {
                    this.todos = response.data;
                });
            },
            storeTodo(){
                this.todoForm.post('/api/v1/todo').then(response => {
            ...
            deleteTodo(todo){
                axios.delete('/api/v1/todo/'+todo.id).then(response => {
